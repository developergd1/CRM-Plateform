...
import { X, Building2, User, Phone, Mail, MapPin, Tag, Sparkles, ShieldCheck, KeyRound, FileText } from 'lucide-react';
    ...
    >
      <div className="bg-white rounded-3xl max-w-lg w-full shadow-2xl border border-slate-200 overflow-hidden my-auto flex flex-col max-h-[90vh]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 flex items-center gap-1.5 mt-0.5">
                <Sparkles className="w-3.5 h-3.5 text-growth-gold shrink-0 />" />
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          {/* Scrollable Form Body with Keyboard Arrow Navigation */}
          <div
            ref={scrollRef}
            tabIndex={0}
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              ...
              <div>
                ...
                <input
                  type="email"
                  placeholder="e.g. contact@apexlogistics.in"
                  value={email}
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. Pass#9821 (Auto-generated if blank)"
